...
const {
  preloadSrc, preloadError, platform, execPath, env, version, versions
...
preloadProcess.version = process.version = version
preloadProcess.versions = process.versions = versions
